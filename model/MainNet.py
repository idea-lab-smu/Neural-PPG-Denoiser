...
class CSFI2(nn.Module):
    def __init__(self, n_feats):
        ...
        self.conv21 = conv3x3(n_feats, n_feats, 1)
...
class CSFI3(nn.Module):
    def __init__(self, n_feats):
        ...
        self.conv31_1 = conv3x3(n_feats, n_feats, 1)
        self.conv31_2 = conv3x3(n_feats, n_feats, 1)
        self.conv32 = conv3x3(n_feats, n_feats, 1)
...
class MainNet(nn.Module):
    def __init__(self, num_res_blocks, n_feats, res_scale):
        ...
        self.ps12 = nn.Conv2d(256, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        ...
        self.ps23 = nn.Conv2d(256, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
